...
#define LAST 100 //c Marcos 

// for defining data type of Proccess
typedef struct
{
    int pid, burst, wait, turntime;
} Process;

void print_table(Process p[], int n);// for printning table of proccess
void print_gantt_chart(Process p[], int n); // for printing ghant chart
